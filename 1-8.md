...
Ans: The Consumer.java file is a basic Kafka consumer, in that it takes the data being created/produced by the Producer (in this case, messages), and reading it into data to return.
